...
## Variable for Question 1: `age_guess_error`



## Question and Variables for Part 2: Is there an association between the `age_guess_error` and the `ethnicity` of the person whose age is being guessed?
