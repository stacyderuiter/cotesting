...
## Variable for Question 1: `latitude`


## Question and Variables for Part 2: Is there an association between the `percent_mortality` observed and the `insecticide_class` being used?
