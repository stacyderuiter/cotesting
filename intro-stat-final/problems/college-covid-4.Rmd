...
Your dataset contains data specifically from college students.
...
- `college_year`: "1st", "2nd", "3rd" or "4th"
- `quarantine_days`: number of days that the person considers themselves to have been "in quarantine"

## Variable for Question 1: `positive_affect`

## Question and Variables for Part 2: Is there an association between the `positive_affect` score of surveyed students and the number of days that they say they have been in quarantine (`quarantine_days`)?

## Data Access

You can find your data at: <https://sldr.netlify.app/data/college-covid-survey.csv>
