...
## Question and Variables for Part 2: Is there an association between a film's profitability, as measured by its `roi`, and its `clean_test` score on the Bechdel test?
