...
## Variable for Question 1: `days_until_normal`

## Question and Variables for Part 2: Is there an association between the `days_until_normal` a person reports and their `wfh` status?
