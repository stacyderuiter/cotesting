...
## Variable for Question 1: `profit_millions`


## Question and Variables for Part 2: Is there an association between a film's profitability, as measured by its `profit_millions`, and its `clean_test` score on the Bechdel test?
