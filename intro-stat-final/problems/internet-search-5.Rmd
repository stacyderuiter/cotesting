...
## Variable for Question 1: `Searches`

## Question and Variables for Part 2: Is there an association between how much a person is swayed by internet search findings (`Vote_Sway`) and the number of internet `Searches` they do per week?
