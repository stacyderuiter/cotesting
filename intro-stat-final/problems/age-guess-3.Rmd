...
## Variable for Question 1: `guessed_age`



## Question and Variables for Part 2: Is there an association between the `actual_age` of the person whose age is being guessed and the `age_guess_error`?
