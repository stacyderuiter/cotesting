...
## Variable for Question 1: `Vote_Sway`

## Question and Variables for Part 2: Is there an association between how much a person is swayed by internet search findings (`Vote_Sway`) and their initial voting preference (`Pre_Vote`)?
