...
## Variable for Question 1: `socialize_min`

## Question and Variables for Part 2: Is there an association between the `socialize_min` a person reports during the pandemic and the number of `housemates` they have?
