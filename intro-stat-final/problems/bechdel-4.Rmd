...
## Variable for Question 1: `roi`


## Question and Variables for Part 2: Is there an association between a film's profitability, as measured by its `profit_millions`, and its profitabiltiy, as measured by its `roi`?
