...
## Variable for Question 1: `worry_scale`

## Question and Variables for Part 2: Is there an association between the `worry_scale` score a person reports during the pandemic and `socialize_min`, the time they spend socializing online or on the phone?
