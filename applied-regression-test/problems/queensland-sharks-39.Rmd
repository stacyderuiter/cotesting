...
sh2 <- sh %>%
  group_by(Species, Area, Location) %>%
...
write_csv(sh2, file = '/Users/sld33/Dropbox/academic-website/static/data/sharks-queensland.csv')
  
```

## Data Access

You can find your data at: <https://sldr.netlify.app/data/sharks-queensland.csv>

## Response Variable

Please fit a regression model using as your response variable: whether a shark was found dead.
