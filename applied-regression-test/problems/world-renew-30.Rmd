...
Please fit a regression model using as your response variable: whether the person did all three sustainable farming practices (minimum tillage, soil covered, and crop rotation).
