...
You can find your data at: <https://sldr.netlify.app/data/koerner_gabon_defaunation2.csv>

## Response Variable

Please fit a regression model using as your response variable: land use in the area. 
