...
Please fit a regression model using as your response variable: total species richness (number of animal species present, including both birds and mammals). 
