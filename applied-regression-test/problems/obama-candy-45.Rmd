...
write_csv(hall, file = '/Users/sld33/Dropbox/academic-website/static/data/obama-candy.csv')
  
```

## Data Access

You can find your data at: <https://sldr.netlify.app/data/obama-candy.csv>

## Response Variable

Please fit a regression model using as your response variable: whether the kid picked fruit as their treat.
...
- `fruit`: 0 if the kid picked candy, and 1 if they picked fruit
